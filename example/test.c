...
main(int argc, char **argv)
{
	...
	debug = strtoInt("debug", data_in_file_ptr, data_holder_size);
	IP = datatoStr("IP", data_in_file_ptr, data_holder_size);
	password = datatoStr("Password", data_in_file_ptr, data_holder_size);
